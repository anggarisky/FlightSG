...
class Qatarflightclock extends Component {
    ...
    return (
      <ScrollView style={{backgroundColor: "#541330"}}>
        <View style={styles.mainbody}>
          ...
          <View style={styles.buttonwrap}>
            <Text style={{marginRight: 12, color: "#FFFFFF", fontSize: 18, fontWeight: "bold"}}>
              BOARDING
            </Text>
            <Button
          ...
          <View style={styles.buttonwrap}>
            <Text style={{marginRight: 10, color: "#FFFFFF", fontSize: 18, fontWeight: "bold"}}>
              PAX DOOR {"\n"} CLOSED
            </Text>
            <Button
          ...
          <View style={styles.buttonwrap}>
            <Text style={{marginRight: 31, color: "#FFFFFF", fontSize: 18, fontWeight: "bold"}}>
              OFF-{"\n"}CHOCKS
            </Text>
            <Button
...
export default Qatarflightclock;
